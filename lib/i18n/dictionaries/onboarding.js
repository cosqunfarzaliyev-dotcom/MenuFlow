...
export const onboarding = {
  az: {
    ...
    wizardIntroTitle: 'Restoranınızı quraşdıraq',
    wizardIntroSubtitle: 'Bir neçə addımda menyunuzu müştərilər üçün hazırlayaq. Hər addımı sonra Admin paneldən də dəyişə bilərsiniz.',
    ...
    categoryNameFieldLabel: 'Kateqoriya adı',
    categoryNameFieldPlaceholder: 'Məs: Əsas yeməklər',
    addCategoryButton: 'Kateqoriya əlavə et',
    categoriesAddedLabel: 'Əlavə olunmuş kateqoriyalar',
    productNameFieldLabel: 'Məhsul adı',
    productNameFieldPlaceholder: 'Məs: Adana Kabab',
    productPriceFieldLabel: 'Qiymət',
    productCategoryFieldLabel: 'Kateqoriya',
    addProductButton: 'Məhsul əlavə et',
    productsAddedLabel: 'Əlavə olunmuş məhsullar',
  ...
  en: {
    ...
    wizardIntroTitle: "Let's set up your restaurant",
    wizardIntroSubtitle: "We'll get your menu ready for customers in a few steps. You can change anything later from the Admin panel.",
    ...
    categoriesAddedLabel: 'Categories added',
  ...
  ru: {
    ...
    finishingButton: 'Завершение…',
    genericSaveError: (msg) => msg || 'Не удалось сохранить. Попробуйте снова.',
    signOutLink: 'Хотите продолжить с другим аккаунтом? Выйдите.',
    wizardIntroTitle: 'Настроим ваш ресторан',
    wizardIntroSubtitle: 'За несколько шагов подготовим ваше меню для клиентов. Всё это можно изменить позже в панели администратора.',
    ...
    categoryNameFieldLabel: 'Название категории',
    categoryNameFieldPlaceholder: 'напр. Основные блюда',
    addCategoryButton: 'Добавить категорию',
    categoriesAddedLabel: 'Добавленные категории',
    productNameFieldLabel: 'Название товара',
    productNameFieldPlaceholder: 'напр. Кебаб Адана',
    productPriceFieldLabel: 'Цена',
    productCategoryFieldLabel: 'Категория',
    addProductButton: 'Добавить товар',
    productsAddedLabel: 'Добавленные товары',
