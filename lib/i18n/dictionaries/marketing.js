...
export const marketing = {
  az: {
    ...
    featureServiceModelsTitle: 'Üç fərqli iş modeli',
    featureServiceModelsDesc: 'Ofisiantlı və sonra ödəniş, ofisiantlı və öncədən ödəniş, yaxud tam özünəxidmət — restoranınızın iş qaydasını seçin, menyu və panellər ona uyğunlaşsın.',
    featureThemingTitle: 'Menyu sizin rənglərinizdə',
    featureThemingDesc: 'Fon, mətn, kart və vurğu rəngini öz brendinizə uyğunlaşdırın — müştəri menyusu dərhal yenilənir.',
    featureMenuTranslationsTitle: 'Menyu məzmununun tərcüməsi',
    featureMenuTranslationsDesc: 'Məhsul və kateqoriya adlarını ingilis və rus dillərində əlavə edin; xarici qonaq menyunu öz dilində oxuyur.',
    featurePushTitle: 'Anlıq bildirişlər',
    featurePushDesc: 'Yeni sifariş və ya çağırış düşəndə işçinin telefonuna push bildirişi gedir — panel açıq olmasa belə.',
    featurePosTitle: 'POS inteqrasiyası',
    featurePosDesc: 'Poster POS ilə menyunu sinxronlaşdırın və sifarişləri birbaşa kassa sisteminizə göndərin.',
    ...
    contactInstagramDescription: 'Menyu dizaynlarımızı və yeniliklərimizi Instagram-da izləyin.',
    contactInstagramButton: 'Instagram-a bax',
  },
  en: {
    ...
    featureServiceModelsTitle: 'Three ways to run the room',
    featureServiceModelsDesc: 'Waiter service paid afterwards, waiter service paid up front, or full self-service — pick how your venue actually works and the menu and panels adapt to it.',
    featureThemingTitle: 'The menu in your colours',
    featureThemingDesc: 'Match the background, text, card and accent colours to your own brand — the customer menu updates instantly.',
    featureMenuTranslationsTitle: 'Translated menu content',
    featureMenuTranslationsDesc: 'Add English and Russian names for products and categories; a visiting guest reads the menu in their own language.',
    featurePushTitle: 'Instant notifications',
    featurePushDesc: 'A push notification reaches your staff the moment an order or a call comes in — even with the panel closed.',
    featurePosTitle: 'POS integration',
    featurePosDesc: 'Sync your menu with Poster POS and send orders straight into your till system.',
    ...
    contactInstagramTitle: 'Instagram',
    contactInstagramDescription: 'Follow our menu designs and updates on Instagram.',
    contactInstagramButton: 'View Instagram',
  },
  ru: {
    ...
    featureServiceModelsTitle: 'Три модели обслуживания',
    featureServiceModelsDesc: 'С официантом и оплатой после, с официантом и оплатой заранее или полное самообслуживание — выберите режим работы, и меню с панелями подстроятся под него.',
    featureThemingTitle: 'Меню в ваших цветах',
    featureThemingDesc: 'Настройте фон, текст, карточки и акцентный цвет под свой бренд — меню клиента обновляется сразу.',
    featureMenuTranslationsTitle: 'Перевод содержимого меню',
    featureMenuTranslationsDesc: 'Добавьте английские и русские названия блюд и категорий — иностранный гость читает меню на своём языке.',
    featurePushTitle: 'Мгновенные уведомления',
    featurePushDesc: 'Push-уведомление приходит сотруднику, как только поступает заказ или вызов — даже если панель закрыта.',
    featurePosTitle: 'Интеграция с POS',
    featurePosDesc: 'Синхронизируйте меню с Poster POS и отправляйте заказы прямо в вашу кассовую систему.',
    ...
    contactInstagramTitle: 'Instagram',
    contactInstagramDescription: 'Следите за нашими дизайнами меню и новостями в Instagram.',
    contactInstagramButton: 'Открыть Instagram',
  },
};
