export const translations = {
  az: {
    ...
    vegOnlyLabel: "VEG",
    noSearchResultsTitle: "Heç nə tapılmadı",
    noSearchResultsDescription: "Başqa açar söz sınayın və ya süzgəci sıfırlayın.",
    clearSearchLabel: "Təmizlə",
    bannerPrevLabel: "Əvvəlki banner",
    bannerNextLabel: "Sonrakı banner",
    bannerGoToLabel: (n, total) => `Banner ${n}/${total}`,
    customisationLabel: "Fərdiləşdirmə",
    nutritionPanelLabel: "Qidalanma dəyəri",
    ...
    // Shown in the cart when restaurants.pay_later_enabled is off (0044): with
    // no "Sonra ödəyəcəyəm" option there is no neutral default, so the customer
    // must pick a real method before the send button unlocks.
    selectPaymentMethodRequired: "Davam etmək üçün ödəniş üsulunu seçin",
    nothingToPay: "Ödəniləcək məbləğ yoxdur.",
    // Epoint onlayn ödənişi (0048_epoint_payment_integration.sql) — cash/
    // card/wallet-dan fərqli olaraq bu, real ödənişdir, staff-a niyyət
    // bildirişi deyil (bax CustomerApp.jsx-in handleEpointPay şərhi).
    // Gateway (Epoint) deliberately never named in any customer-facing
    // string here — only "Apple Pay / Google Pay". See CustomerApp.jsx's
    // handleEpointPay comment.
    payWithWallet: "Apple Pay / Google Pay",
    walletPreparing: "Hazırlanır...",
    walletWidgetTitle: "Apple Pay / Google Pay ilə ödəyin",
    walletCheckingStatus: "Ödəniş yoxlanılır...",
    walletPaymentSuccess: "Ödəniş uğurla tamamlandı!",
    walletPaymentPending: "Ödəniş hələ təsdiqlənir, bir azdan yenidən yoxlayın.",
    walletPaymentFailed: "Ödəniş tamamlanmadı. Yenidən cəhd edin.",
    // CartDrawer.jsx: sifariş göndərilib, amma checkout zamanı Epoint ödənişi
    // tamamlanmayıb (ləğv/xəta/vaxt bitməsi) — hesabı sonra "Hesabı ödə"
    // ekranından ödəmək olar.
    walletPaymentIncompleteNote: "Sifariş göndərildi, lakin ödəniş tamamlanmadı. Hesabı sonra \"Hesabı ödə\" bölməsindən ödəyə bilərsiniz.",
    // Shown instead of the whole menu once the tab has been backgrounded for
    // 30s with no active order (CustomerApp's background-clear effect).
    sessionExpiredTitle: "Sessiya bitdi",
    sessionExpiredDescription: "Menyunu yenidən açmaq üçün masadakı QR kodu oxudun.",
    ...
    // Self-service (0045): no waiter carries anything over — the customer is
    // told where to collect it instead.
    orderSuccessDescSelfService: "üçün sifarişiniz mətbəxə çatdırıldı. Hazır olanda bildiriləcək, kassadan götürə bilərsiniz.",
    table: "Masa:",
    ...
    // Self-service only (0045) — the READY status, which a waiter-service
    // customer never needs to act on, is the whole point here.
    statusReadyForPickup: "Hazırdır — kassadan götürün",
    statusCancelled: "Ləğv edilib",
    piece: "ədəd",
    waiterRequestNote: "Ofisiant xahiş olunur",
    billRequestNote: "Hesab istənilir",
    checkoutPaymentDeclaredNote: "Ödəniş üsulu sifariş zamanı seçildi",
  ...
  en: {
    ...
    noSearchResultsDescription: "Try a different search or clear the filter.",
    clearSearchLabel: "Clear",
    bannerPrevLabel: "Previous banner",
    bannerNextLabel: "Next banner",
    bannerGoToLabel: (n, total) => `Banner ${n} of ${total}`,
    customisationLabel: "Customisation",
    nutritionPanelLabel: "Nutrition panel",
    proteinLabel: "Protein",
    carbsLabel: "Carbs",
    fatLabel: "Fat",
    navMenu: "Menu",
    ...
    selectPaymentMethodRequired: "Choose a payment method to continue",
    nothingToPay: "There's nothing to pay.",
    payWithWallet: "Apple Pay / Google Pay",
    walletPreparing: "Preparing...",
    walletWidgetTitle: "Pay with Apple Pay / Google Pay",
    walletCheckingStatus: "Checking payment status...",
    walletPaymentSuccess: "Payment completed successfully!",
    walletPaymentPending: "Payment is still being confirmed — check back shortly.",
    walletPaymentFailed: "Payment did not go through. Please try again.",
    walletPaymentIncompleteNote: "The order was sent, but the payment did not complete. You can pay later from \"Pay bill\".",
    sessionExpiredTitle: "Session ended",
    sessionExpiredDescription: "Scan the QR code on your table to open the menu again.",
    genericError: "Something went wrong.",
    orderSent: "Order Sent!",
    orderSuccessDesc: "your order has been sent to the waiter and kitchen. Estimated prep time: 15-20 min.",
    orderSuccessDescSelfService: "your order has been sent to the kitchen. We'll let you know when it's ready to collect from the counter.",
    table: "Table:",
    ...
    statusReadyForPickup: "Ready — collect at the counter",
    statusCancelled: "Cancelled",
    piece: "pcs",
    waiterRequestNote: "Waiter requested",
    billRequestNote: "Bill requested",
    checkoutPaymentDeclaredNote: "Payment method chosen at checkout",
  ...
  ru: {
    ...
    noSearchResultsDescription: "Попробуйте другой запрос или сбросьте фильтр.",
    clearSearchLabel: "Очистить",
    bannerPrevLabel: "Предыдущий баннер",
    bannerNextLabel: "Следующий баннер",
    bannerGoToLabel: (n, total) => `Баннер ${n} из ${total}`,
    customisationLabel: "Настройка",
    nutritionPanelLabel: "Пищевая ценность",
    proteinLabel: "Белки",
    carbsLabel: "Углеводы",
    fatLabel: "Жиры",
    navMenu: "Меню",
    ...
    selectPaymentMethodRequired: "Выберите способ оплаты, чтобы продолжить",
    nothingToPay: "Нечего оплачивать.",
    payWithWallet: "Apple Pay / Google Pay",
    walletPreparing: "Подготовка...",
    walletWidgetTitle: "Оплата через Apple Pay / Google Pay",
    walletCheckingStatus: "Проверка статуса оплаты...",
    walletPaymentSuccess: "Оплата успешно завершена!",
    walletPaymentPending: "Оплата ещё подтверждается, проверьте немного позже.",
    walletPaymentFailed: "Оплата не прошла. Попробуйте ещё раз.",
    walletPaymentIncompleteNote: "Заказ отправлен, но оплата не завершена. Вы можете оплатить позже в разделе «Оплатить счёт».",
    sessionExpiredTitle: "Сессия завершена",
    sessionExpiredDescription: "Отсканируйте QR-код на столе, чтобы снова открыть меню.",
    ...
    orderSuccessDescSelfService: "ваш заказ передан на кухню. Мы сообщим, когда его можно будет забрать на кассе.",
    table: "Стол:",
    ...
    statusReadyForPickup: "Готово — заберите на кассе",
    statusCancelled: "Отменён",
    piece: "шт",
    waiterRequestNote: "Вызов официанта",
    billRequestNote: "Запрос счета",
    checkoutPaymentDeclaredNote: "Способ оплаты выбран при заказе",
...
// Prioritet: DB tərcüməsi (0029_product_category_translations.sql,
// admin-redaktə edilə bilər, real restoran məhsulları üçün) → köhnə demo map
// (yalnız data/menu.json-un statik seed id-lərinə uyğun gəlir, offline/
// Supabase-siz rejimi qorumaq üçün saxlanılır) → AZ mənbə dəyəri. `category`/
// `product` heç vaxt klonlanmır ('az' üçün eyni referens qaytarılır) —
// mövcud ucuz perf invariantı.
export function getLocalizedCategoryName(category, lang = 'az') {
  if (!category || lang === 'az') return category?.name;
  const dbName = category.translations?.[lang]?.name;
  if (dbName) return dbName;
  return categoryTranslations[category.id]?.[lang] || category.name;
}

export function getLocalizedProduct(product, lang = 'az') {
  if (!product || lang === 'az') return product;
  const db = product.translations?.[lang];
  if (db?.name || db?.description) {
    return {
      ...product,
  ...
  const legacy = productTranslations[product.id]?.[lang];
  if (legacy) {
    return {
      ...product,
      name: legacy.name || product.name,
      description: legacy.description || product.description
    };
  }
  return product;
}
