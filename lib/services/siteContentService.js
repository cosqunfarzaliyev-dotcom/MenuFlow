...
// Separate from SITE_CONTENT_GROUPS (not folded into `contact`): these four
...
// tabs by editing UX, not by table. contact.instagram_url added in
// 0036_site_content_instagram.sql, seeded blank like contact.address — a
// SuperAdmin fills it in from SiteContactTab; the footer/contact page skip
// the Instagram card entirely while it's empty rather than showing a dead
// link.
export const CONTACT_DETAIL_KEYS = ['contact.whatsapp_url', 'contact.email', 'contact.address', 'contact.instagram_url'];
