...
class RealtimeManager {
  ...
  async subscribeCampaigns(handler, options) { return this.subscribe('campaigns', handler, options); }
...
export const subscribeCampaigns = (handler, options) => manager.subscribeCampaigns(handler, options);
